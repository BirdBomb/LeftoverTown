...
public class GameUI_InfoWindow : MonoBehaviour
{
    public CanvasScaler canvasScaler_Panel;
    public RectTransform rectTransform_Info;
    public RectTransform rectTransform_BG;
