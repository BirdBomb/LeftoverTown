...
public class UI_Grid_CabinetSteal : UI_Grid
{
    ...
    {
        MessageBroker.Default.Publish(new GameEvent.GameEvent_Local_SomeoneCommit()
        {
            actor = GameLocalManager.Instance.localPlayer.actorManager,
            fine = (short)(ItemConfigData.GetItemConfig(before.Item_ID).Average_Value * before.Item_Count)
        });
