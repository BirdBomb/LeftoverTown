...
public class GroundConfigData 
{
    ...
    public readonly static List<GroundConfig> groundConfigs = new List<GroundConfig>()
    {
        ...
        /*浅草*/new GroundConfig(){ Ground_ID = 1002,Ground_Age = AgeGroup.Nature,Ground_Color = new Color32(27,88,33,255),
            Ground_Raw=new List<ItemRaw>(){ new ItemRaw(1001,2) } },
        /*苔原*/new GroundConfig(){ Ground_ID = 1003,Ground_Age = AgeGroup.Nature,Ground_Color = new Color32(94,121,134,255),
            Ground_Raw=new List<ItemRaw>(){ new ItemRaw(1001,2) } },
        /*雪原*/new GroundConfig(){ Ground_ID = 1004,Ground_Age = AgeGroup.Nature,Ground_Color = new Color32(155,160,160,255),
            Ground_Raw=new List<ItemRaw>(){ new ItemRaw(1001,2) } },
        /*沙漠*/new GroundConfig(){ Ground_ID = 1005,Ground_Age = AgeGroup.Nature,Ground_Color = new Color32(175,147,92,255),
            Ground_Raw=new List<ItemRaw>(){ new ItemRaw(1001,2) } },
        /*沼泽*/new GroundConfig(){ Ground_ID = 1006,Ground_Age = AgeGroup.Nature,Ground_Color = new Color32(175,147,92,255),
            Ground_Raw=new List<ItemRaw>(){ new ItemRaw(1001,2) } },
        /*木制地板*/new GroundConfig(){ Ground_ID = 2000,Ground_Age = AgeGroup.Wood,Ground_Color = new Color32(129,91,53,255),
            Ground_Raw=new List<ItemRaw>(){ new ItemRaw(1001,2) } },
        /*石砖地板*/new GroundConfig(){ Ground_ID = 2001,Ground_Age = AgeGroup.Wood,Ground_Color = new Color32(93,102,116,255),
            Ground_Raw=new List<ItemRaw>(){ new ItemRaw(1001,2) } },
        /*人造耕地*/new GroundConfig(){ Ground_ID = 2002,Ground_Age = AgeGroup.Nature,Ground_Color = new Color32(57,37,31,255),
            Ground_Raw=new List<ItemRaw>(){ new ItemRaw(1001,2) } },
        /*金属地砖*/new GroundConfig(){ Ground_ID = 2003,Ground_Age = AgeGroup.Nature,Ground_Color = new Color32(57,37,31,255),
            Ground_Raw=new List<ItemRaw>(){ new ItemRaw(1001,2) } },
