...
public class BuildingConfigData : MonoBehaviour
{
    ...
    public readonly static List<BuildingConfig> buildConfigs = new List<BuildingConfig>()
    {
        ...
        new BuildingConfig(){ Building_ID = 1003,Building_Name ="简易木窗",
            Building_FileName ="WoodWindow",Building_SpriteName="WoodWindow",Building_RawLevel = 1,
            Building_Raw = new List<BuildingRaw>(){ new BuildingRaw(1001,4),new BuildingRaw(1002,5) } },
        ...
        new BuildingConfig(){ Building_ID = 1028,Building_Name ="铁门",
            ...
            Building_Raw = new List<BuildingRaw>(){ new BuildingRaw(1001,4),new BuildingRaw(1002,5) } },
        new BuildingConfig(){ Building_ID = 1029,Building_Name ="砖窗",
            Building_FileName ="BrickWindow",Building_SpriteName="BrickWindow",Building_RawLevel = 2,
            Building_Raw = new List<BuildingRaw>(){ new BuildingRaw(1001,4),new BuildingRaw(1002,5) } },
