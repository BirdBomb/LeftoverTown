...
public class CreateListConfigData
{
    ...
    public readonly static List<CreateListConfig> createListConfigs = new List<CreateListConfig>()
    {
        new CreateListConfig()
        {
            ID = 3003,
            Name = "木制工具台",
            List = new List<int> { 1100,2000,2010,2020,2030,2040,2050,2060,2100,2200,5000,5200,5400,5500,9000}
        },
        new CreateListConfig()
        {
            ID = 4000,
            Name = "铁制工具台",
            List = new List<int> { 1200,2011,2021,2101,2102,2103,2201,2202,5001,5002,5003,5004,5201,5204,5401,5402,5403,5501 }
        },
        new CreateListConfig()
        {
            ID = 4001,
