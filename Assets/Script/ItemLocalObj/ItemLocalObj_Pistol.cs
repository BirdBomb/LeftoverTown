...
public class ItemLocalObj_Pistol : ItemLocalObj
{
    [SerializeField]
    ...
    [SerializeField]
    private Transform transform_Pistol;
    ...
    public void Shoot(short bulletID, Vector3 dir)
    {
        ...
        transform_Pistol.DOKill();
        transform_Pistol.localPosition = Vector3.zero;
        transform_Pistol.DOPunchPosition(vector3_KickBack, config_ShotCD);
        transform_Pistol.localRotation = Quaternion.identity;
        transform_Pistol.DOPunchRotation(new Vector3(0, 0, float_KickOn), config_ShotCD);
    }
    public void Dull()
    {
