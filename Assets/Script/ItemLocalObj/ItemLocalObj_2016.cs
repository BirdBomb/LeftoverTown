...
public class ItemLocalObj_2016 : ItemLocalObj
{
    ...
    public void Shoot(short bulletID,Vector3 dir, ActorManager from)
    {
        ...
        obj.GetComponent<BulletBase>().InitBullet(dir, 10, from.NetManager);
        ...
        AudioManager.Instance.PlayEffect(1001, from.transform.position);
    ...
    {
        AudioManager.Instance.PlayEffect(1002, from.transform.position);
    }
}
