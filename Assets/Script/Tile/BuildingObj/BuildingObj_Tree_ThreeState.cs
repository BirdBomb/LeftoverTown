...
public class BuildingObj_Tree_ThreeState : BuildingObj_Growth_ThreeState
{
    ...
    public void PlayBrokenEffects()
    {
        AudioManager.Instance?.Play3DEffect(3001, transform.position);
    ...
    {
        if (!bool_Shadow || state_Now == State.Growing) return;
