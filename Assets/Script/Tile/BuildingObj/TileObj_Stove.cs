...
public class TileObj_Stove : MonoBehaviour
{
    ...
    //        uI_Grid_Fuel.Open();
    //        uI_Grid_Fuel.BindAction_ChangeInfo(TryToChangeInfo);
    //        uI_Grid_Fuel.BindAction_Fuel(BindAddFuelAction, BindIgniteFuelAction);
    //        uI_Grid_Fuel.BindTileObj(this);
    //        uI_Grid_Fuel.UpdateInfo(fuelVal, fuelMax, fuelItem);
    //    }
    //    else
    //    {
    ...
    //        uI_Grid_CookPanel.Open();
    //        uI_Grid_CookPanel.BindAction_ChangeInfo(TryToChangeInfo);
    //        uI_Grid_CookPanel.BindAction_Cook(BindAddRawlAction, BindCookAction, BindPutOutFood);
    //        uI_Grid_CookPanel.BindTileObj(this);
    //        uI_Grid_CookPanel.UpdateInfo(cookRawDataList, cookResultData, cookVal, cookMax);
    //    }
    //    else
    //    {
    ...
    //            sprite_Item.transform.localScale = Vector3.one;
    //            sprite_Item.transform.DOPunchScale(new Vector3(-0.1f, 0.2f, 0), 0.2f).SetEase(Ease.InOutBack);
    //        }
    //        else
    //        {
