...
public class BuildingObj_Home_Bandit : BuildingObj_Manmade
{
    ...
    [Header("土匪上班时间")]
    public GlobalTime globalTime_Work;
    ...
    private TileUI_BanditBox tileUI_Bind;
    ...
    public override void OpenOrCloseUI(bool open)
    {
        if (open)
        {
            ...
            tileUI_Bind = tileUI.GetComponent<TileUI_BanditBox>();
    ...
    private void CreateActor()
    {
        MessageBroker.Default.Publish(new GameEvent.GameEvent_State_SpawnActor()
        {
            ...
            callBack = ((actor) =>
            {
                ...
                actor.GetComponent<ActorManager_NPC_Bandit>().globalTime_Work = globalTime_Work;
            })
        });
    }
