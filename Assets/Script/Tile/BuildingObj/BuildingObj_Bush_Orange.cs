...
public class BuildingObj_Bush_Orange : BuildingObj
{
    private enum State
    {
        State0, State1
    ...
    #endregion
    #region//生成动物
    private ActorManager_Animal_Chicken chicken;
    private void CreateChicken()
    {
        if (new System.Random().Next(0, 100) < 5 && chicken == null)
        {
