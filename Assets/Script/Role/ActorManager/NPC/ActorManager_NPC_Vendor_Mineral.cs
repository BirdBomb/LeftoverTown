    ...
    public override void Local_SetDialog(ActorManager player, int index)
    {
        ...
        switch (index)
        {
            case 0:
                ...
                dialogOption_0.optionEntry = "Vendor_Mineral_Dialog0_Option0";
                dialogOption_0.optionAction = (() =>
                {
                    Local_OverDialog(player);
                });
                dialogOption_1.optionTable = "Role_String";
                dialogOption_1.optionEntry = "Vendor_Mineral_Dialog0_Option1";
                ...
                tileUI_Dialog.InitDialog("Role_String", "Vendor_Mineral_Name", "Role_String", "Vendor_Mineral_Dialog0");
