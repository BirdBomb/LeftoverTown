...
/// 厨师
/// </summary>
public class ActorManager_NPC_Chef : ActorManager_NPC
{
    #region//监听
    ...
    public override void Local_SetDialog(ActorManager player, int index)
    {
        ...
        switch (index)
        {
            case 0:
                ...
                dialogOption_0.optionEntry = "Chef_Dialog0_Option0";
                dialogOption_0.optionAction = (() =>
                {
                    Local_OverDialog(player);
                });
                dialogOption_1.optionTable = "Role_String";
                dialogOption_1.optionEntry = "Chef_Dialog0_Option1";
                ...
                tileUI_Dialog.InitDialog("Role_String", "Chef_Name", "Role_String", "Chef_Dialog0");
