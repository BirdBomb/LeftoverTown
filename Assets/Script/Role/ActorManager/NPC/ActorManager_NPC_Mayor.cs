    ...
    public override void Local_SetDialog(ActorManager player, int index)
    {
        ...
        switch (index)
        {
            case 0:
                ...
                dialogOption_0.optionEntry = "Mayor_Dialog0_Option0";
                dialogOption_0.optionAction = (() =>
                {
                    Local_OverDialog(player);
                });
                dialogOption_1.optionTable = "Role_String";
                dialogOption_1.optionEntry = "Mayor_Dialog0_Option1";
                ...
                tileUI_Dialog.InitDialog("Role_String", "Mayor_Name", "Role_String", "Mayor_Dialog0");
