...
/// 市长
/// </summary>
public class ActorManager_NPC_Mayor : ActorManager_NPC
{
    #region//行为逻辑
    /// <summary>
    /// 根据时间决定动作(经常触发)
    ...
    {
        return buildingTile.tileID == 2013;
    }
    #endregion
    #region//交互
    ...
    public void Dialog_Start()
    {
        ...
        {
            new DialogOption("Mayor_Dialog0_Option0", Local_StartDeal),
            new DialogOption("Mayor_Dialog0_Option1", Local_OverDialog)
        };
        ShowDialog("Mayor_Dialog0", options);
    }
    #endregion
    #region//交易
